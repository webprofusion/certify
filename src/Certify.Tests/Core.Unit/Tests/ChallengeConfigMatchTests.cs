...
namespace Certify.Tests.Core.Unit.Tests
{
    ...
    public class ChallengeConfigMatchTests
    {
        ...
        public void ChallengeDelegationRuleTests()
        {
            ...
            var result = DnsChallengeHelper.ApplyChallengeDelegationRule("test.com", "_acme-challenge.test.com", testRule);
            ...
            result = DnsChallengeHelper.ApplyChallengeDelegationRule("www.subdomain.test.com", "_acme-challenge.www.subdomain.test.com", testRule);
            ...
            result = DnsChallengeHelper.ApplyChallengeDelegationRule("test.com", "_acme-challenge.test.com", testRule);
            Assert.AreEqual("_acme-challenge.auth.test.co.uk", result);
            ...
            result = DnsChallengeHelper.ApplyChallengeDelegationRule("www.subdomain.example.com", "_acme-challenge.www.subdomain.example.com", testRule);
        ...
        {
            var result = DnsChallengeHelper.ApplyChallengeDelegationRule("test.com", "_acme-challenge.test.com", null);
