...
#pragma warning restore IDE1006 // Naming Styles
    ...
    public class DnsProviderCertifyDns : IDnsProvider
    {
            ...
            get
            {
                return new ChallengeProviderDefinition
                {
                    ...
                    ProviderParameters = new List<ProviderParameter>{
                        ...
                        new ProviderParameter{ Key="key",Name="API Key", IsRequired=true, IsCredential=true, IsPassword=false,  Description="Certify DNS API Key" }
                    },
        ...
        {
            _settingsPath = Management.Util.GetAppDataFolder();
        ...
        private async Task<ValueTuple<AcmeDnsRegistration, bool>> Register(string settingsPath, string domainId)
        {
            ...
            req.Headers.Add("X-Api-Key", _credentials["key"]);
