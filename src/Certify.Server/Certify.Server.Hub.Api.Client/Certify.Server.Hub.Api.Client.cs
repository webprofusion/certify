...
namespace Certify.Server.Hub.Api
{
    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        {
            BaseUrl = "https://local.dev.certificatemanager.app:44361/";
        ...
        public virtual System.Threading.Tasks.Task<object> GetSHA256HashBase64Async(string body)
        {
            return GetSHA256HashBase64Async(body, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Returns an OK response containing a list of ActionStep objects.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<object> GetSHA256HashBase64Async(string body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "internal/v1/access/sha256hash"
                    urlBuilder_.Append("internal/v1/access/sha256hash");
        ...
        /// <summary>
        /// Check a given security principal has permissions to perform a specific action for a specific resource action [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<bool> CheckSecurityPrincipalHasAccessAsync(AccessCheck body)
        {
            return CheckSecurityPrincipalHasAccessAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<bool> CheckSecurityPrincipalHasAccessAsync(AccessCheck body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/access/securityprincipal/allowedaction"
                    urlBuilder_.Append("internal/v1/access/securityprincipal/allowedaction");
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<AssignedRole>> GetSecurityPrincipalAssignedRolesAsync(string id)
        {
            return GetSecurityPrincipalAssignedRolesAsync(id, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<AssignedRole>> GetSecurityPrincipalAssignedRolesAsync(string id, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/access/securityprincipal/{id}/assignedroles"
                    urlBuilder_.Append("internal/v1/access/securityprincipal/");
        ...
        /// <summary>
        /// Get list of Assigned Roles etc for a given security principal [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<RoleStatus> GetSecurityPrincipalRoleStatusAsync(string id)
        {
            return GetSecurityPrincipalRoleStatusAsync(id, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<RoleStatus> GetSecurityPrincipalRoleStatusAsync(string id, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/access/securityprincipal/{id}/rolestatus"
                    urlBuilder_.Append("internal/v1/access/securityprincipal/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(id, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        /// <summary>
        /// Update the title, description and role scope of an assigned access token, keeping the issued token [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ActionResult> UpdateAssignedAccessTokenAsync(AssignedAccessToken body)
        {
            return UpdateAssignedAccessTokenAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ActionResult> UpdateAssignedAccessTokenAsync(AssignedAccessToken body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/access/assignedtoken/update"
                    urlBuilder_.Append("internal/v1/access/assignedtoken/update");
        ...
        /// <summary>
        /// Get list of available security principals [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<SecurityPrincipal>> GetSecurityPrincipalsAsync()
        {
            return GetSecurityPrincipalsAsync(System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<SecurityPrincipal>> GetSecurityPrincipalsAsync(System.Threading.CancellationToken cancellationToken)
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/access/securityprincipals"
                    urlBuilder_.Append("internal/v1/access/securityprincipals");
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<SecurityPrincipal>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <summary>
        /// Check password valid for security principal [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<SecurityPrincipalCheckResponse> ValidateSecurityPrincipalPasswordAsync(SecurityPrincipalPasswordCheck body)
        {
            return ValidateSecurityPrincipalPasswordAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<SecurityPrincipalCheckResponse> ValidateSecurityPrincipalPasswordAsync(SecurityPrincipalPasswordCheck body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<SecurityPrincipalCheckResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <summary>
        /// Update password for security principal [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ActionResult> UpdateSecurityPrincipalPasswordAsync(SecurityPrincipalPasswordUpdate body)
        {
            return UpdateSecurityPrincipalPasswordAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ActionResult> UpdateSecurityPrincipalPasswordAsync(SecurityPrincipalPasswordUpdate body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
        ...
        /// <summary>
        /// Add new security principal [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ActionResult> AddSecurityPrincipalAsync(SecurityPrincipal body)
        {
            return AddSecurityPrincipalAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ActionResult> AddSecurityPrincipalAsync(SecurityPrincipal body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/access/securityprincipal"
                    urlBuilder_.Append("internal/v1/access/securityprincipal");
        ...
        /// <summary>
        /// Remove security principal [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ActionResult> RemoveSecurityPrincipalAsync(string id)
        {
            return RemoveSecurityPrincipalAsync(id, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ActionResult> RemoveSecurityPrincipalAsync(string id, System.Threading.CancellationToken cancellationToken)
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
        ...
        /// <summary>
        /// Update existing security principal [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ActionResult> UpdateSecurityPrincipalAsync(SecurityPrincipal body)
        {
            return UpdateSecurityPrincipalAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ActionResult> UpdateSecurityPrincipalAsync(SecurityPrincipal body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/access/securityprincipal/update"
                    urlBuilder_.Append("internal/v1/access/securityprincipal/update");
        ...
        /// <summary>
        /// Update assigned roles for a security principal [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ActionResult> UpdateSecurityPrincipalAssignedRolesAsync(SecurityPrincipalAssignedRoleUpdate body)
        {
            return UpdateSecurityPrincipalAssignedRolesAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ActionResult> UpdateSecurityPrincipalAssignedRolesAsync(SecurityPrincipalAssignedRoleUpdate body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/access/securityprincipal/roles/update"
                    urlBuilder_.Append("internal/v1/access/securityprincipal/roles/update");
        ...
        /// <summary>
        /// Query the hub activity feed, newest first [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ActivityQueryResult> GetActivityAsync(ActivityQuery body)
        {
            return GetActivityAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ActivityQueryResult> GetActivityAsync(ActivityQuery body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/activity/query"
                    urlBuilder_.Append("internal/v1/activity/query");
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ActivityQueryResult>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <summary>
        /// Get daily totals of certificate request outcomes and deferred renewals [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ActivityDailyTotal>> GetActivityTotalsAsync(ActivityTotalsQuery body)
        {
            return GetActivityTotalsAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ActivityDailyTotal>> GetActivityTotalsAsync(ActivityTotalsQuery body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/activity/totals"
                    urlBuilder_.Append("internal/v1/activity/totals");
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<ActivityDailyTotal>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <summary>
        /// Query certificate request run history, newest first [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<RequestRunQueryResult> GetRequestRunsAsync(RequestRunQuery body)
        {
            return GetRequestRunsAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<RequestRunQueryResult> GetRequestRunsAsync(RequestRunQuery body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/activity/runs"
                    urlBuilder_.Append("internal/v1/activity/runs");
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<RequestRunQueryResult>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <summary>
        /// Get a certificate request run with its stages and messages [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<RequestRun> GetRequestRunAsync(string runId)
        {
            return GetRequestRunAsync(runId, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<RequestRun> GetRequestRunAsync(string runId, System.Threading.CancellationToken cancellationToken)
        {
            if (runId == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/activity/runs/{runId}"
                    urlBuilder_.Append("internal/v1/activity/runs/");
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<RequestRun>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <summary>
        /// Get the certificates and instances which need attention [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<AttentionItem>> GetAttentionItemsAsync(HubViewFilter body)
        {
            return GetAttentionItemsAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<AttentionItem>> GetAttentionItemsAsync(HubViewFilter body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/activity/attention"
                    urlBuilder_.Append("internal/v1/activity/attention");
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<AttentionItem>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <summary>
        /// Get the renewals planned over the coming days, and certificates expiring before a renewal is planned [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<UpcomingRenewals> GetUpcomingRenewalsAsync(UpcomingRenewalsQuery body)
        {
            return GetUpcomingRenewalsAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<UpcomingRenewals> GetUpcomingRenewalsAsync(UpcomingRenewalsQuery body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/activity/upcoming"
                    urlBuilder_.Append("internal/v1/activity/upcoming");
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<UpcomingRenewals>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <summary>
        /// Get when each managed instance was connected, not responding or disconnected over a period [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<InstanceConnectionHistory>> GetInstanceConnectionHistoryAsync(InstanceConnectionQuery body)
        {
            return GetInstanceConnectionHistoryAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<InstanceConnectionHistory>> GetInstanceConnectionHistoryAsync(InstanceConnectionQuery body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/activity/instances/connections"
                    urlBuilder_.Append("internal/v1/activity/instances/connections");
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<InstanceConnectionHistory>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <summary>
        /// Get the certificate status counts as they stood about a day ago, to compare with the current counts [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<StatusSummaryBaseline> GetStatusSummaryBaselineAsync(HubViewFilter body)
        {
            return GetStatusSummaryBaselineAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<StatusSummaryBaseline> GetStatusSummaryBaselineAsync(HubViewFilter body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/activity/summary/baseline"
                    urlBuilder_.Append("internal/v1/activity/summary/baseline");
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<StatusSummaryBaseline>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<AccountDetails>> GetAcmeAccountsAsync(string instanceId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/certificateauthority/{instanceId}/accounts"
        ...
        public virtual async System.Threading.Tasks.Task<ActionResult> AddAcmeAccountAsync(string instanceId, ContactRegistration body, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/certificateauthority/{instanceId}/account"
                    urlBuilder_.Append("internal/v1/certificateauthority/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        {
            return GetCertificateAuthoritiesAsync(instanceId, System.Threading.CancellationToken.None);
        }
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<CertificateAuthority>> GetCertificateAuthoritiesAsync(string instanceId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/certificateauthority/{instanceId}/authority"
                    urlBuilder_.Append("internal/v1/certificateauthority/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append("/authority");
        ...
        {
            return UpdateCertificateAuthorityAsync(instanceId, body, System.Threading.CancellationToken.None);
        }
        ...
        {
            return RemoveCertificateAuthorityAsync(instanceId, id, System.Threading.CancellationToken.None);
        }
        ...
        public virtual async System.Threading.Tasks.Task<ActionResult> RemoveCertificateAuthorityAsync(string instanceId, string id, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/certificateauthority/{instanceId}/authority/{id}"
                    urlBuilder_.Append("internal/v1/certificateauthority/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append("/authority/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(id, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        {
            return RemoveAcmeAccountAsync(instanceId, storageKey, deactivate, System.Threading.CancellationToken.None);
        }
        ...
        public virtual async System.Threading.Tasks.Task<ActionResult> RemoveAcmeAccountAsync(string instanceId, string storageKey, bool deactivate, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/certificateauthority/{instanceId}/accounts/{storageKey}/{deactivate}"
                    urlBuilder_.Append("internal/v1/certificateauthority/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append("/accounts/");
        ...
        {
            return GetChallengeProvidersAsync(instanceId, System.Threading.CancellationToken.None);
        }
        ...
        public virtual async System.Threading.Tasks.Task<DnsZoneQueryResult> GetDnsZonesAsync(string instanceId, string providerTypeId, string credentialId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/challengeprovider/{instanceId}/dnszones/{providerTypeId}/{credentialId}"
                    urlBuilder_.Append("internal/v1/challengeprovider/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append("/dnszones/");
        ...
        /// <summary>
        /// Get Deployment Task Provider Definition [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<DeploymentProviderDefinition> GetDeploymentProviderDefinitionAsync(string instanceId, string id, DeploymentTaskConfig body)
        {
            return GetDeploymentProviderDefinitionAsync(instanceId, id, body, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<DeploymentProviderDefinition> GetDeploymentProviderDefinitionAsync(string instanceId, string id, DeploymentTaskConfig body, System.Threading.CancellationToken cancellationToken)
        {
            if (instanceId == null)
                throw new System.ArgumentNullException("instanceId");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/deploymenttask/{instanceId}/{id}"
                    urlBuilder_.Append("internal/v1/deploymenttask/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append('/');
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(id, System.Globalization.CultureInfo.InvariantCulture)));
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<DeploymentProviderDefinition>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ManagedInstanceInfo> GetHubManagedInstanceAsync(string id)
        {
            return GetHubManagedInstanceAsync(id, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ManagedInstanceInfo> GetHubManagedInstanceAsync(string id, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/hub/instances/{id}"
                    urlBuilder_.Append("internal/v1/hub/instances/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(id, System.Globalization.CultureInfo.InvariantCulture)));
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ManagedInstanceInfo>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ActionResult> UpdateHubManagedInstanceAsync(string id, ManagedInstanceInfo body)
        {
            return UpdateHubManagedInstanceAsync(id, body, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ActionResult> UpdateHubManagedInstanceAsync(string id, ManagedInstanceInfo body, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");
        ...
        {
            return RemoveHubManagedInstanceAsync(id, System.Threading.CancellationToken.None);
        }
        ...
        {
            return GetSystemStatusItemsAsync(instanceId, System.Threading.CancellationToken.None);
        }
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ActionStep>> GetSystemStatusItemsAsync(string instanceId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/hub/status/{instanceId}"
                    urlBuilder_.Append("internal/v1/hub/status/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ManagedCertificateSummary>> GetSubscribableManagedCertificatesAsync()
        {
            return GetSubscribableManagedCertificatesAsync(System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ManagedCertificateSummary>> GetSubscribableManagedCertificatesAsync(System.Threading.CancellationToken cancellationToken)
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/hub/subscription/available"
                    urlBuilder_.Append("internal/v1/hub/subscription/available");
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<ManagedCertificateSummary>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <br/>previewed: a managed instance subscribes to them, while a user or application downloads them, and both
        /// <br/>are permitted by the same certificate download action.
        /// </summary>
        ...
        /// <summary>
        /// Register a managed instance with the Certify The Web dashboard [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ActionResult> RegisterManagedInstanceWithDashboardAsync(string instanceId)
        {
            return RegisterManagedInstanceWithDashboardAsync(instanceId, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ActionResult> RegisterManagedInstanceWithDashboardAsync(string instanceId, System.Threading.CancellationToken cancellationToken)
        {
            if (instanceId == null)
                throw new System.ArgumentNullException("instanceId");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/hub/instances/{instanceId}/dashboard/register"
                    urlBuilder_.Append("internal/v1/hub/instances/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append("/dashboard/register");
        ...
        /// <summary>
        /// Remove a managed instance from the Certify The Web dashboard [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ActionResult> RemoveManagedInstanceFromDashboardAsync(string instanceId)
        {
            return RemoveManagedInstanceFromDashboardAsync(instanceId, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ActionResult> RemoveManagedInstanceFromDashboardAsync(string instanceId, System.Threading.CancellationToken cancellationToken)
        {
            if (instanceId == null)
                throw new System.ArgumentNullException("instanceId");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/hub/instances/{instanceId}/dashboard/remove"
                    urlBuilder_.Append("internal/v1/hub/instances/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append("/dashboard/remove");
        ...
        /// <summary>
        /// Command a managed instance to rejoin the management hub using the latest joining key [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ActionResult> RejoinManagedInstanceAsync(string instanceId)
        {
            return RejoinManagedInstanceAsync(instanceId, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ActionResult> RejoinManagedInstanceAsync(string instanceId, System.Threading.CancellationToken cancellationToken)
        {
            if (instanceId == null)
                throw new System.ArgumentNullException("instanceId");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/hub/instances/{instanceId}/rejoin"
                    urlBuilder_.Append("internal/v1/hub/instances/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append("/rejoin");
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ActionResult> RejoinAllManagedInstancesAsync()
        {
            return RejoinAllManagedInstancesAsync(System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ActionResult> RejoinAllManagedInstancesAsync(System.Threading.CancellationToken cancellationToken)
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
        ...
        /// <br/>registered against and when it was last used.
        /// </summary>
        ...
        /// <br/>client which registered it can no longer sign requests and would have to register again.
        /// </summary>
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ManagedChallengeSummary>> GetManagedChallengeSummariesAsync()
        {
            return GetManagedChallengeSummariesAsync(System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>List of managed challenge summaries with their tags</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ManagedChallengeSummary>> GetManagedChallengeSummariesAsync(System.Threading.CancellationToken cancellationToken)
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/managedchallenges"
                    urlBuilder_.Append("internal/v1/managedchallenges");
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<ManagedChallengeSummary>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<TagSummary>> GetManagedChallengeTagsAsync(string id)
        {
            return GetManagedChallengeTagsAsync(id, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>List of tags assigned to the managed challenge</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<TagSummary>> GetManagedChallengeTagsAsync(string id, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/managedchallenges/{id}/tags"
                    urlBuilder_.Append("internal/v1/managedchallenges/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(id, System.Globalization.CultureInfo.InvariantCulture)));
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<TagSummary>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// </summary>
        /// <param name="id">The managed challenge ID</param>
        /// <param name="body">Tags to add</param>
        /// <returns>Action result</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ActionResult> AddManagedChallengeTagsAsync(string id, System.Collections.Generic.IEnumerable<TagScope> body)
        {
            return AddManagedChallengeTagsAsync(id, body, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Action result</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ActionResult> AddManagedChallengeTagsAsync(string id, System.Collections.Generic.IEnumerable<TagScope> body, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");
        ...
        /// <returns>Action result</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ActionResult> RemoveManagedChallengeTagAsync(string id, string categoryKey, string value)
        {
            return RemoveManagedChallengeTagAsync(id, categoryKey, value, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Action result</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ActionResult> RemoveManagedChallengeTagAsync(string id, string categoryKey, string value, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    if (categoryKey != null)
                    {
                        urlBuilder_.Append(System.Uri.EscapeDataString("categoryKey")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(categoryKey, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
                    }
                    if (value != null)
                    {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<CertIdentifierItem>> IdentifiersFromCSRAsync(string body)
        {
            return IdentifiersFromCSRAsync(body, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<CertIdentifierItem>> IdentifiersFromCSRAsync(string body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/preview/csr/identifiers"
                    urlBuilder_.Append("internal/v1/preview/csr/identifiers");
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<CertIdentifierItem>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        {
            return GetStoredCredentialsAsync(instanceId, System.Threading.CancellationToken.None);
        }
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<StoredCredential>> GetStoredCredentialsAsync(string instanceId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/credentials/{instanceId}"
        ...
        {
            return UpdateStoredCredentialAsync(instanceId, body, System.Threading.CancellationToken.None);
        }
        ...
        {
            return RemoveStoredCredentialAsync(instanceId, storageKey, System.Threading.CancellationToken.None);
        }
        ...
        public virtual async System.Threading.Tasks.Task<ActionResult> RemoveStoredCredentialAsync(string instanceId, string storageKey, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/credentials/{instanceId}/{storageKey}"
                    urlBuilder_.Append("internal/v1/credentials/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append('/');
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(storageKey, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        public virtual async System.Threading.Tasks.Task<StoredCredentialUnlockResult> UnlockStoredCredentialAsync(string instanceId, string storageKey, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "api/v1/storedcredential/{instanceId}/{storageKey}/unlock"
                    urlBuilder_.Append("api/v1/storedcredential/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append('/');
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(storageKey, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        {
            return GetTargetServiceTypesAsync(instanceId, System.Threading.CancellationToken.None);
        }
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<string>> GetTargetServiceTypesAsync(string instanceId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/target/{instanceId}/types"
                    urlBuilder_.Append("internal/v1/target/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        {
            return GetTargetServiceItemsAsync(instanceId, serviceType, System.Threading.CancellationToken.None);
        }
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<SiteInfo>> GetTargetServiceItemsAsync(string instanceId, string serviceType, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/target/{instanceId}/{serviceType}/items"
                    urlBuilder_.Append("internal/v1/target/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append('/');
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(serviceType, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        {
            return GetTargetServiceItemIdentifiersAsync(instanceId, serviceType, itemId, System.Threading.CancellationToken.None);
        }
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<DomainOption>> GetTargetServiceItemIdentifiersAsync(string instanceId, string serviceType, string itemId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/target/{instanceId}/{serviceType}/item/{itemId}/identifiers"
                    urlBuilder_.Append("internal/v1/target/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append('/');
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(serviceType, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<OidcLoginResponse> BeginOidcLoginAsync(string provider, string returnUrl)
        {
            return BeginOidcLoginAsync(provider, returnUrl, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Authorization URL for client redirect</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<OidcLoginResponse> BeginOidcLoginAsync(string provider, string returnUrl, System.Threading.CancellationToken cancellationToken)
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "api/v1/auth/oidc/login"
                    urlBuilder_.Append("api/v1/auth/oidc/login");
                    urlBuilder_.Append('?');
                    if (provider != null)
                    {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<OidcLoginResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// </summary>
        /// <param name="body">Error description</param>
        /// <returns>Authentication result</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<AuthResponse> CompleteOidcLoginAsync(OidcCallbackBody body)
        {
            return CompleteOidcLoginAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Authentication result</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<AuthResponse> CompleteOidcLoginAsync(OidcCallbackBody body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "api/v1/auth/oidc/login-callback"
                    urlBuilder_.Append("api/v1/auth/oidc/login-callback");
        ...
        {
            return DownloadAsync(instanceId, managedCertId, format, System.Threading.CancellationToken.None);
        }
        ...
        public virtual async System.Threading.Tasks.Task<FileResponse> DownloadAsync(string instanceId, string managedCertId, string format, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "api/v1/certificate/{instanceId}/download/{managedCertId}/{format}"
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<object> GetDecodedCertificateAsync(string instanceId, string managedCertId, bool? strictExport)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<object> GetDecodedCertificateAsync(string instanceId, string managedCertId, bool? strictExport, System.Threading.CancellationToken cancellationToken)
        {
            if (instanceId == null)
                throw new System.ArgumentNullException("instanceId");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/certificate/{instanceId}/{managedCertId}/decoded"
                    urlBuilder_.Append("internal/v1/certificate/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append('/');
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(managedCertId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        public virtual async System.Threading.Tasks.Task<LogResult> DownloadLogAsync(string instanceId, string managedCertId, object maxLines, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/certificate/{managedCertId}/log"
                    urlBuilder_.Append("internal/v1/certificate/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(managedCertId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        {
            return DownloadLogTextAsync(instanceId, managedCertId, System.Threading.CancellationToken.None);
        }
        ...
        public virtual async System.Threading.Tasks.Task<FileResponse> DownloadLogTextAsync(string instanceId, string managedCertId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/certificate/{managedCertId}/log/download"
                    urlBuilder_.Append("internal/v1/certificate/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(managedCertId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append("/log/download");
                    urlBuilder_.Append('?');
                    if (instanceId != null)
                    {
                        urlBuilder_.Append(System.Uri.EscapeDataString("instanceId")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
        ...
        public virtual async System.Threading.Tasks.Task<StatusSummary> GetManagedCertificateSummaryAsync(System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/certificate/summary"
                    urlBuilder_.Append("internal/v1/certificate/summary");
        ...
        public virtual async System.Threading.Tasks.Task<StatusSummary> GetInstanceManagedCertificateSummaryAsync(string instanceId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/certificate/{instanceId}/summary"
                    urlBuilder_.Append("internal/v1/certificate/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        public virtual async System.Threading.Tasks.Task<ManagedCertificate> GetManagedCertificateDetailsAsync(string instanceId, string managedCertId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/certificate/{instanceId}/settings/{managedCertId}"
                    urlBuilder_.Append("internal/v1/certificate/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        public virtual async System.Threading.Tasks.Task<ManagedCertificate> UpdateManagedCertificateDetailsAsync(string instanceId, ManagedCertificate body, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/certificate/{instanceId}/settings/update"
                    urlBuilder_.Append("internal/v1/certificate/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ManagedCertificateSummary> AddManagedCertificateAsync(ManagedCertificateAddRequest body)
        {
            return AddManagedCertificateAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ManagedCertificateSummary> AddManagedCertificateAsync(ManagedCertificateAddRequest body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ManagedCertificateSummary>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        public virtual async System.Threading.Tasks.Task BeginOrderAsync(string instanceId, string id, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/certificate/order"
                    urlBuilder_.Append("internal/v1/certificate/order");
                    urlBuilder_.Append('?');
                    if (instanceId != null)
                    {
                        urlBuilder_.Append(System.Uri.EscapeDataString("instanceId")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<StatusMessage>> PerformConfigurationTestAsync(string instanceId, ManagedCertificate body, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/certificate/test"
                    urlBuilder_.Append("internal/v1/certificate/test");
                    urlBuilder_.Append('?');
                    if (instanceId != null)
                    {
                        urlBuilder_.Append(System.Uri.EscapeDataString("instanceId")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ManagedCertificate> ResetStatusAsync(string instanceId, string id)
        {
            return ResetStatusAsync(instanceId, id, System.Threading.CancellationToken.None);
        }
        ...
        /// <param name="id">managed item id</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ManagedCertificate> ResetStatusAsync(string instanceId, string id, System.Threading.CancellationToken cancellationToken)
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/certificate/reset"
                    urlBuilder_.Append("internal/v1/certificate/reset");
                    urlBuilder_.Append('?');
                    if (instanceId != null)
                    {
                        urlBuilder_.Append(System.Uri.EscapeDataString("instanceId")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
        ...
        /// <br/>If the token has tag-scoped restrictions, only challenges with matching tags can be used.
        /// </summary>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ActionResult> PerformManagedChallengeAsync(ManagedChallengeRequest body)
        {
            return PerformManagedChallengeAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        public virtual async System.Threading.Tasks.Task<ActionResult> PerformManagedChallengeAsync(ManagedChallengeRequest body, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "api/v1/managedchallenge/request"
                    urlBuilder_.Append("api/v1/managedchallenge/request");
        ...
        /// <br/>Requires API token with ManagedChallengeConsumer role.
        /// </summary>
        /// <returns>Accepted</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ManagedChallengeOperation> BeginManagedChallengeAsync(ManagedChallengeRequest body)
        {
            return BeginManagedChallengeAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Accepted</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ManagedChallengeOperation> BeginManagedChallengeAsync(ManagedChallengeRequest body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "api/v1/managedchallenge/requestbegin"
                    urlBuilder_.Append("api/v1/managedchallenge/requestbegin");
                    ...
                    try
                    {
                        ...
                        if (status_ == 202)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ManagedChallengeOperation>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        {
            return GetManagedChallengeOperationStatusAsync(id, System.Threading.CancellationToken.None);
        }
        ...
        public virtual async System.Threading.Tasks.Task<ManagedChallengeOperation> GetManagedChallengeOperationStatusAsync(string id, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "api/v1/managedchallenge/requeststatus/{id}"
                    urlBuilder_.Append("api/v1/managedchallenge/requeststatus/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(id, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        {
            return CleanupManagedChallengeAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        public virtual async System.Threading.Tasks.Task<ActionResult> CleanupManagedChallengeAsync(ManagedChallengeRequest body, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "api/v1/managedchallenge/cleanup"
                    urlBuilder_.Append("api/v1/managedchallenge/cleanup");
        ...
        {
            return GetManagedChallengesAsync(System.Threading.CancellationToken.None);
        }
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ManagedChallenge>> GetManagedChallengesAsync(System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "api/v1/managedchallenge/list"
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<ManagedChallenge>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        {
            return UpdateManagedChallengeAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        public virtual async System.Threading.Tasks.Task<ActionResult> UpdateManagedChallengeAsync(ManagedChallenge body, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "api/v1/managedchallenge/update"
                    urlBuilder_.Append("api/v1/managedchallenge/update");
        ...
        {
            return RemoveManagedChallengeAsync(id, System.Threading.CancellationToken.None);
        }
        ...
        public virtual async System.Threading.Tasks.Task<ActionResult> RemoveManagedChallengeAsync(string id, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "api/v1/managedchallenge/remove"
                    urlBuilder_.Append("api/v1/managedchallenge/remove");
                    urlBuilder_.Append('?');
                    if (id != null)
                    {
                        urlBuilder_.Append(System.Uri.EscapeDataString("id")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(id, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
        ...
        /// <summary>
        /// Get list of managed product license keys for instance license management [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ManagedLicense>> GetManagedLicensesAsync()
        {
            return GetManagedLicensesAsync(System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ManagedLicense>> GetManagedLicensesAsync(System.Threading.CancellationToken cancellationToken)
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/managedlicense/list"
                    urlBuilder_.Append("internal/v1/managedlicense/list");
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<ManagedLicense>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <summary>
        /// Add a managed license [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ActionResult> AddManagedLicenseAsync(ManagedLicense body)
        {
            return AddManagedLicenseAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ActionResult> AddManagedLicenseAsync(ManagedLicense body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/managedlicense/add"
                    urlBuilder_.Append("internal/v1/managedlicense/add");
        ...
        /// <summary>
        /// Update a managed license [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ActionResult> UpdateManagedLicenseAsync(ManagedLicense body)
        {
            return UpdateManagedLicenseAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ActionResult> UpdateManagedLicenseAsync(ManagedLicense body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/managedlicense/update"
                    urlBuilder_.Append("internal/v1/managedlicense/update");
        ...
        /// <summary>
        /// Delete a managed license [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ActionResult> RemoveManagedLicenseAsync(string id)
        {
            return RemoveManagedLicenseAsync(id, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ActionResult> RemoveManagedLicenseAsync(string id, System.Threading.CancellationToken cancellationToken)
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/managedlicense/remove"
                    urlBuilder_.Append("internal/v1/managedlicense/remove");
                    urlBuilder_.Append('?');
                    if (id != null)
                    {
                        urlBuilder_.Append(System.Uri.EscapeDataString("id")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(id, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
        ...
        /// <summary>
        /// Activate a managed license for an instance [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ActionResult> ActivateManagedLicenseAsync(string instanceId, string licenseId)
        {
            return ActivateManagedLicenseAsync(instanceId, licenseId, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ActionResult> ActivateManagedLicenseAsync(string instanceId, string licenseId, System.Threading.CancellationToken cancellationToken)
        {
            if (instanceId == null)
                throw new System.ArgumentNullException("instanceId");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/managedlicense/activate/{licenseId}/{instanceId}"
                    urlBuilder_.Append("internal/v1/managedlicense/activate/");
        ...
        /// <summary>
        /// Deactivate a managed license for an instance [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ActionResult> DeactivateManagedLicenseAsync(string instanceId)
        {
            return DeactivateManagedLicenseAsync(instanceId, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ActionResult> DeactivateManagedLicenseAsync(string instanceId, System.Threading.CancellationToken cancellationToken)
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/managedlicense/deactivate"
                    urlBuilder_.Append("internal/v1/managedlicense/deactivate");
                    urlBuilder_.Append('?');
                    if (instanceId != null)
                    {
                        urlBuilder_.Append(System.Uri.EscapeDataString("instanceId")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
        ...
        /// <summary>
        /// Get status for a managed license [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<LicenseCheckResult> GetManagedLicenseStatusAsync(string id)
        {
            return GetManagedLicenseStatusAsync(id, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<LicenseCheckResult> GetManagedLicenseStatusAsync(string id, System.Threading.CancellationToken cancellationToken)
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/managedlicense/status"
                    urlBuilder_.Append("internal/v1/managedlicense/status");
                    urlBuilder_.Append('?');
                    if (id != null)
                    {
                        urlBuilder_.Append(System.Uri.EscapeDataString("id")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(id, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<LicenseCheckResult>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        public virtual async System.Threading.Tasks.Task<AuthProviderInfo> GetSupportedProvidersAsync(System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/oidcprovider/providers"
                    urlBuilder_.Append("internal/v1/oidcprovider/providers");
        ...
        /// <summary>
        /// Get list of oidc providers [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<OidcProviderConfig>> GetOidcProvidersAsync()
        {
            return GetOidcProvidersAsync(System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<OidcProviderConfig>> GetOidcProvidersAsync(System.Threading.CancellationToken cancellationToken)
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/oidcprovider/list"
                    urlBuilder_.Append("internal/v1/oidcprovider/list");
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<OidcProviderConfig>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <summary>
        /// Add an Oidc Provider [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ActionResult> AddOidcProviderAsync(OidcProviderConfig body)
        {
            return AddOidcProviderAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ActionResult> AddOidcProviderAsync(OidcProviderConfig body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/oidcprovider/add"
                    urlBuilder_.Append("internal/v1/oidcprovider/add");
        ...
        /// <summary>
        /// Update a Oidc Provider [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ActionResult> UpdateOidcProviderAsync(OidcProviderConfig body)
        {
            return UpdateOidcProviderAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ActionResult> UpdateOidcProviderAsync(OidcProviderConfig body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/oidcprovider/update"
                    urlBuilder_.Append("internal/v1/oidcprovider/update");
        ...
        /// <summary>
        /// Delete an Oidc Provider [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ActionResult> RemoveOidcProviderAsync(string id)
        {
            return RemoveOidcProviderAsync(id, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ActionResult> RemoveOidcProviderAsync(string id, System.Threading.CancellationToken cancellationToken)
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/oidcprovider/remove"
                    urlBuilder_.Append("internal/v1/oidcprovider/remove");
                    urlBuilder_.Append('?');
                    if (id != null)
                    {
                        urlBuilder_.Append(System.Uri.EscapeDataString("id")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(id, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ManagedInstanceSummary>> GetPublicManagedInstancesAsync()
        {
            return GetPublicManagedInstancesAsync(System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ManagedInstanceSummary>> GetPublicManagedInstancesAsync(System.Threading.CancellationToken cancellationToken)
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<ManagedInstanceSummary>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<DataStoreStatus> GetDataStoreStatusAsync()
        {
            return GetDataStoreStatusAsync(System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<DataStoreStatus> GetDataStoreStatusAsync(System.Threading.CancellationToken cancellationToken)
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/system/datastore/status"
                    urlBuilder_.Append("internal/v1/system/datastore/status");
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<DataStoreStatus>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
                        ...
                        if (status_ == 503)
                        {
                            ...
                            throw new ApiException<DataStoreStatus>("Service Unavailable", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        {
                            var responseData_ = response_.Content == null ? null : await ReadAsStringAsync(response_.Content, cancellationToken).ConfigureAwait(false);
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ActionResult> AttemptDataStoreReconnectionAsync()
        {
            return AttemptDataStoreReconnectionAsync(System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ActionResult> AttemptDataStoreReconnectionAsync(System.Threading.CancellationToken cancellationToken)
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/system/datastore/reconnect"
                    urlBuilder_.Append("internal/v1/system/datastore/reconnect");
                    ...
                    try
                    {
                        ...
                        if (status_ == 500)
                        {
                            ...
                            throw new ApiException<ActionResult>("Internal Server Error", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        {
                            var responseData_ = response_.Content == null ? null : await ReadAsStringAsync(response_.Content, cancellationToken).ConfigureAwait(false);
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<FileResponse> DownloadSystemLogAsync(string instanceId, string logName)
        {
            return DownloadSystemLogAsync(instanceId, logName, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<FileResponse> DownloadSystemLogAsync(string instanceId, string logName, System.Threading.CancellationToken cancellationToken)
        {
            if (instanceId == null)
                throw new System.ArgumentNullException("instanceId");

            if (logName == null)
                throw new System.ArgumentNullException("logName");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "api/v1/{instanceId}/system/logs/download/{logName}"
                    urlBuilder_.Append("api/v1/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append("/system/logs/download/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(logName, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        public virtual async System.Threading.Tasks.Task<HubJoiningInfo> RegisterAsync(System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "api/v1/hub/register"
                    urlBuilder_.Append("api/v1/hub/register");
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<HubJoiningInfo>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        public virtual async System.Threading.Tasks.Task<HubJoiningInfo> CheckJoiningAsync(bool? register, bool? reissueRequestAuthSecret, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "api/v1/hub/joincheck"
                    urlBuilder_.Append("api/v1/hub/joincheck");
                    urlBuilder_.Append('?');
                    if (register != null)
                    {
        ...
        /// <summary>
        /// Get current info for the instance [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ManagedInstanceInfo> GetManagedInstanceInfoAsync(string instanceId)
        {
            return GetManagedInstanceInfoAsync(instanceId, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ManagedInstanceInfo> GetManagedInstanceInfoAsync(string instanceId, System.Threading.CancellationToken cancellationToken)
        {
            if (instanceId == null)
                throw new System.ArgumentNullException("instanceId");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/system/instance/{instanceId}"
                    urlBuilder_.Append("internal/v1/system/instance/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        public virtual async System.Threading.Tasks.Task<ImportExportPackage> PerformInstanceExportAsync(string instanceId, ExportRequest body, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/system/api/v1/{instanceId}/migration/export"
                    urlBuilder_.Append("internal/v1/system/api/v1/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append("/migration/export");
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ActionStep>> PerformInstanceImportAsync(string instanceId, ImportRequest body, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/system/api/v1/{instanceId}/migration/import"
                    urlBuilder_.Append("internal/v1/system/api/v1/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append("/migration/import");
        ...
        {
            return GetInstanceStatusItemsAsync(instanceId, System.Threading.CancellationToken.None);
        }
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ActionStep>> GetInstanceStatusItemsAsync(string instanceId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/system/{instanceId}/system/status"
                    urlBuilder_.Append("internal/v1/system/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append("/system/status");
        ...
        /// <summary>
        /// Get datastore providers for a managed instance [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ProviderDefinition>> GetDataStoreProvidersAsync(string instanceId)
        {
            return GetDataStoreProvidersAsync(instanceId, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ProviderDefinition>> GetDataStoreProvidersAsync(string instanceId, System.Threading.CancellationToken cancellationToken)
        {
            if (instanceId == null)
                throw new System.ArgumentNullException("instanceId");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/system/{instanceId}/system/datastore/providers"
                    urlBuilder_.Append("internal/v1/system/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append("/system/datastore/providers");
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<ProviderDefinition>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <summary>
        /// Get datastore connections for a managed instance [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<DataStoreConnection>> GetDataStoresAsync(string instanceId)
        {
            return GetDataStoresAsync(instanceId, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<DataStoreConnection>> GetDataStoresAsync(string instanceId, System.Threading.CancellationToken cancellationToken)
        {
            if (instanceId == null)
                throw new System.ArgumentNullException("instanceId");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/system/{instanceId}/system/datastore"
                    urlBuilder_.Append("internal/v1/system/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append("/system/datastore");
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<DataStoreConnection>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <summary>
        /// Add or update datastore connection for a managed instance [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ActionStep>> UpdateDataStoreAsync(string instanceId, DataStoreConnection body)
        {
            return UpdateDataStoreAsync(instanceId, body, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ActionStep>> UpdateDataStoreAsync(string instanceId, DataStoreConnection body, System.Threading.CancellationToken cancellationToken)
        {
            if (instanceId == null)
                throw new System.ArgumentNullException("instanceId");
        ...
        /// <summary>
        /// Test datastore connection and schema for a managed instance [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ActionStep>> TestDataStoreAsync(string instanceId, DataStoreConnection body)
        {
            return TestDataStoreAsync(instanceId, body, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ActionStep>> TestDataStoreAsync(string instanceId, DataStoreConnection body, System.Threading.CancellationToken cancellationToken)
        {
            if (instanceId == null)
                throw new System.ArgumentNullException("instanceId");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/system/{instanceId}/system/datastore/test"
                    urlBuilder_.Append("internal/v1/system/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        /// <summary>
        /// Set default datastore for a managed instance [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ActionStep>> SetDefaultDataStoreAsync(string instanceId, string dataStoreId)
        {
            return SetDefaultDataStoreAsync(instanceId, dataStoreId, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ActionStep>> SetDefaultDataStoreAsync(string instanceId, string dataStoreId, System.Threading.CancellationToken cancellationToken)
        {
            if (instanceId == null)
                throw new System.ArgumentNullException("instanceId");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/system/{instanceId}/system/datastore/default/{dataStoreId}"
                    urlBuilder_.Append("internal/v1/system/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append("/system/datastore/default/");
        ...
        /// <summary>
        /// Copy datastore contents from source to target for a managed instance [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ActionStep>> CopyDataStoreToTargetAsync(string instanceId, string sourceId, string destId)
        {
            return CopyDataStoreToTargetAsync(instanceId, sourceId, destId, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ActionStep>> CopyDataStoreToTargetAsync(string instanceId, string sourceId, string destId, System.Threading.CancellationToken cancellationToken)
        {
            if (instanceId == null)
                throw new System.ArgumentNullException("instanceId");
            ...
            if (destId == null)
                throw new System.ArgumentNullException("destId");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/system/{instanceId}/system/datastore/migrate/{sourceId}/{destId}"
                    urlBuilder_.Append("internal/v1/system/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append("/system/datastore/migrate/");
                    ...
                    urlBuilder_.Append('/');
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(destId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        /// <summary>
        /// Remove datastore connection for a managed instance [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ActionStep>> RemoveDataStoreAsync(string instanceId, string dataStoreId)
        {
            return RemoveDataStoreAsync(instanceId, dataStoreId, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ActionStep>> RemoveDataStoreAsync(string instanceId, string dataStoreId, System.Threading.CancellationToken cancellationToken)
        {
            if (instanceId == null)
                throw new System.ArgumentNullException("instanceId");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/system/{instanceId}/system/datastore/delete/{dataStoreId}"
                    urlBuilder_.Append("internal/v1/system/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append("/system/datastore/delete/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(dataStoreId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        /// <summary>
        /// Get recent system log files for a managed instance [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<SystemLogFileInfo>> GetSystemLogFilesAsync(string instanceId)
        {
            return GetSystemLogFilesAsync(instanceId, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<SystemLogFileInfo>> GetSystemLogFilesAsync(string instanceId, System.Threading.CancellationToken cancellationToken)
        {
            if (instanceId == null)
                throw new System.ArgumentNullException("instanceId");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/system/{instanceId}/system/logs"
                    urlBuilder_.Append("internal/v1/system/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append("/system/logs");
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<SystemLogFileInfo>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<string>> GetSystemLogAsync(string instanceId, string logName, object maxLines, System.Threading.CancellationToken cancellationToken)
        {
            ...
            if (maxLines == null)
                throw new System.ArgumentNullException("maxLines");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/system/{instanceId}/system/logs/content/{logName}/{maxLines}"
                    urlBuilder_.Append("internal/v1/system/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append("/system/logs/content/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(logName, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append('/');
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(maxLines, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        {
            return GetServiceConfigAsync(instanceId, System.Threading.CancellationToken.None);
        }
        ...
        public virtual async System.Threading.Tasks.Task<ServiceConfig> GetServiceConfigAsync(string instanceId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/system/{instanceId}/system/serviceconfig"
                    urlBuilder_.Append("internal/v1/system/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ServiceConfig>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        {
            return GetServiceCoreSettingsAsync(instanceId, System.Threading.CancellationToken.None);
        }
        ...
        public virtual async System.Threading.Tasks.Task<Preferences> GetServiceCoreSettingsAsync(string instanceId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/system/{instanceId}/system/coresettings"
                    urlBuilder_.Append("internal/v1/system/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        /// <summary>
        /// Get all tag categories [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<TagCategory>> GetTagCategoriesAsync()
        {
            return GetTagCategoriesAsync(System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<TagCategory>> GetTagCategoriesAsync(System.Threading.CancellationToken cancellationToken)
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/tag/categories"
                    urlBuilder_.Append("internal/v1/tag/categories");
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<TagCategory>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <summary>
        /// Add or update a tag category [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ActionResult> AddOrUpdateTagCategoryAsync(TagCategory body)
        {
            return AddOrUpdateTagCategoryAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ActionResult> AddOrUpdateTagCategoryAsync(TagCategory body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
        ...
        /// <summary>
        /// Get a tag category by key [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<TagCategory> GetTagCategoryAsync(string categoryKey)
        {
            return GetTagCategoryAsync(categoryKey, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<TagCategory> GetTagCategoryAsync(string categoryKey, System.Threading.CancellationToken cancellationToken)
        {
            if (categoryKey == null)
                throw new System.ArgumentNullException("categoryKey");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/tag/categories/{categoryKey}"
                    urlBuilder_.Append("internal/v1/tag/categories/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(categoryKey, System.Globalization.CultureInfo.InvariantCulture)));
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<TagCategory>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <summary>
        /// Delete a tag category [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ActionResult> DeleteTagCategoryAsync(string categoryKey)
        {
            return DeleteTagCategoryAsync(categoryKey, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ActionResult> DeleteTagCategoryAsync(string categoryKey, System.Threading.CancellationToken cancellationToken)
        {
            if (categoryKey == null)
                throw new System.ArgumentNullException("categoryKey");
        ...
        /// <summary>
        /// Get tag values (optional category filter) [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<TagValue>> GetTagValuesAsync(string categoryKey)
        {
            return GetTagValuesAsync(categoryKey, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<TagValue>> GetTagValuesAsync(string categoryKey, System.Threading.CancellationToken cancellationToken)
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/tag/values"
                    urlBuilder_.Append("internal/v1/tag/values");
                    urlBuilder_.Append('?');
                    if (categoryKey != null)
                    {
                        urlBuilder_.Append(System.Uri.EscapeDataString("categoryKey")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(categoryKey, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<TagValue>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <summary>
        /// Get or create a tag value [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<TagValue> GetOrCreateTagValueAsync(TagValueRequest body)
        {
            return GetOrCreateTagValueAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<TagValue> GetOrCreateTagValueAsync(TagValueRequest body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<TagValue>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <summary>
        /// Update a tag value [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ActionResult> UpdateTagValueAsync(TagValueUpdateRequest body)
        {
            return UpdateTagValueAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ActionResult> UpdateTagValueAsync(TagValueUpdateRequest body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/tag/values/update"
                    urlBuilder_.Append("internal/v1/tag/values/update");
        ...
        /// <summary>
        /// Delete a tag value [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ActionResult> DeleteTagValueAsync(string valueId)
        {
            return DeleteTagValueAsync(valueId, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ActionResult> DeleteTagValueAsync(string valueId, System.Threading.CancellationToken cancellationToken)
        {
            if (valueId == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/tag/values/{valueId}"
                    urlBuilder_.Append("internal/v1/tag/values/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(valueId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        /// <summary>
        /// Merge tag values [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ActionResult> MergeTagValuesAsync(TagValueMergeRequest body)
        {
            return MergeTagValuesAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ActionResult> MergeTagValuesAsync(TagValueMergeRequest body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/tag/values/merge"
                    urlBuilder_.Append("internal/v1/tag/values/merge");
        ...
        /// <summary>
        /// Get all item tags [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ItemTag>> GetAllHubItemTagsAsync(string categoryKey, string value, string itemType, string instanceId)
        {
            return GetAllHubItemTagsAsync(categoryKey, value, itemType, instanceId, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ItemTag>> GetAllHubItemTagsAsync(string categoryKey, string value, string itemType, string instanceId, System.Threading.CancellationToken cancellationToken)
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/tag/items"
                    urlBuilder_.Append("internal/v1/tag/items");
                    urlBuilder_.Append('?');
                    if (categoryKey != null)
                    {
                        urlBuilder_.Append(System.Uri.EscapeDataString("categoryKey")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(categoryKey, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
                    ...
                    if (itemType != null)
                    {
                        urlBuilder_.Append(System.Uri.EscapeDataString("itemType")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(itemType, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
                    }
                    if (instanceId != null)
                    {
                        urlBuilder_.Append(System.Uri.EscapeDataString("instanceId")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
        ...
        /// <summary>
        /// Add tags to items [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ActionResult> AddHubItemTagsAsync(System.Collections.Generic.IEnumerable<ItemTag> body)
        {
            return AddHubItemTagsAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ActionResult> AddHubItemTagsAsync(System.Collections.Generic.IEnumerable<ItemTag> body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
        ...
        /// <summary>
        /// Remove item tags by id [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ActionResult> RemoveHubItemTagsAsync(System.Collections.Generic.IEnumerable<string> body)
        {
            return RemoveHubItemTagsAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ActionResult> RemoveHubItemTagsAsync(System.Collections.Generic.IEnumerable<string> body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
        ...
        /// <summary>
        /// Get tags for an item [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<TagSummary>> GetHubItemTagsAsync(string itemType, string itemId)
        {
            return GetHubItemTagsAsync(itemType, itemId, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<TagSummary>> GetHubItemTagsAsync(string itemType, string itemId, System.Threading.CancellationToken cancellationToken)
        {
            if (itemType == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/tag/items/{itemType}/{itemId}"
                    urlBuilder_.Append("internal/v1/tag/items/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(itemType, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append('/');
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(itemId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        /// <summary>
        /// Bulk add/remove tags [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ActionResult> BulkTagOperationAsync(BulkTagOperationRequest body)
        {
            return BulkTagOperationAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ActionResult> BulkTagOperationAsync(BulkTagOperationRequest body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/tag/items/bulk"
                    urlBuilder_.Append("internal/v1/tag/items/bulk");
        ...
        /// <summary>
        /// Preview resources matching tag scopes [Generated]
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ScopePreviewResult> PreviewTagScopeAsync(ScopePreviewRequest body)
        {
            return PreviewTagScopeAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ScopePreviewResult> PreviewTagScopeAsync(ScopePreviewRequest body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/tag/scope-preview"
                    urlBuilder_.Append("internal/v1/tag/scope-preview");
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ScopePreviewResult>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<SimpleAuthorizationChallengeItem>> GetValidationChallengesAsync(string type, string key, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/validation/{type}/{key}"
                    urlBuilder_.Append("internal/v1/validation/");
