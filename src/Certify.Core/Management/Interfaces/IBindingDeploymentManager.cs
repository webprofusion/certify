...
namespace Certify.Core.Management
{
    ...
    {
        Task<List<ActionStep>> StoreAndDeploy(IBindingDeploymentTarget deploymentTarget, ManagedCertificate managedCertificate, string pfxPath, string pfxPwd, bool isPreviewOnly, string certStoreName, bool storeIntermediates = false, string keyStorageProviderName = null, ILog log = null);
