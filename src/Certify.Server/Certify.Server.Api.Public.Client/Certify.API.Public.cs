...
namespace Certify.API.Public
{
    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<StoredCredential>> GetStoredCredentialsAsync(string instanceId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/storedcredential/credentials/{instanceId}"
                    urlBuilder_.Append("internal/v1/storedcredential/credentials/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ActionResult> DeleteStoredCredentialAsync(string instanceId, string storageKey)
        {
            return DeleteStoredCredentialAsync(instanceId, storageKey, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ActionResult> DeleteStoredCredentialAsync(string instanceId, string storageKey, System.Threading.CancellationToken cancellationToken)
        {
            if (instanceId == null)
                throw new System.ArgumentNullException("instanceId");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "internal/v1/storedcredential/credentials/{instanceId}/{storageKey}"
                    urlBuilder_.Append("internal/v1/storedcredential/credentials/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(instanceId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append('/');
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(storageKey, System.Globalization.CultureInfo.InvariantCulture)));
